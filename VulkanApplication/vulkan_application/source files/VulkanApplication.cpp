...
uint32_t find_memory_type(VkPhysicalDevice physical_device, VkDevice device,
	...
	VkBuffer& buffer, VkDeviceMemory& buffer_memory)
{
	...
	VkMemoryAllocateInfo alloc_info = {};
	{
		...
		alloc_info.memoryTypeIndex = find_memory_type(physical_device, device,
	...
	VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& image_memory)
{
	...
	VkMemoryAllocateInfo allocInfo = {};
	{
		...
		allocInfo.memoryTypeIndex = find_memory_type(physical_device, device,
...
VulkanApplication::ExecutionStatus VulkanApplication::init_window()
{
	...
	// glfw set window callback
	{
		glfwSetWindowUserPointer(_window.get(), this);
		glfwSetWindowSizeCallback(_window.get(), VulkanApplication::on_window_resized);
	}

	// glfw hwnd hinstance
	{
		_hwnd = glfwGetWin32Window(_window.get());
...
void VulkanApplication::on_window_resized(GLFWwindow* window, int width, int height)
{
...
void VulkanApplication::create_renderpass()
{
...
void VulkanApplication::create_frame_buffers()
{
...
void VulkanApplication::create_depth_image()
{
	const std::vector<VkFormat>& candidates = {
		VK_FORMAT_D32_SFLOAT, VK_FORMAT_D32_SFLOAT_S8_UINT, VK_FORMAT_D24_UNORM_S8_UINT
	};
...
void VulkanApplication::create_depth_image_view()
{
	const std::vector<VkFormat>& candidates = {
		VK_FORMAT_D32_SFLOAT, VK_FORMAT_D32_SFLOAT_S8_UINT, VK_FORMAT_D24_UNORM_S8_UINT
	};
...
void VulkanApplication::create_indice_buffer()
{
	void* data;
	VkBuffer staging_buffer, buffer;
	VkDeviceMemory staging_buffer_memory, buffer_memory;
...
void VulkanApplication::create_uniform_buffer()
{
	VkBuffer buffer;
...
void VulkanApplication::create_descriptor_set()
{
...
void VulkanApplication::update_uniform_buffer()
{
...
void VulkanApplication::load_model()
{
...
void VulkanApplication::clear_swapchain()
{
